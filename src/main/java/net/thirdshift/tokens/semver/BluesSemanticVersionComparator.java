 ...
 * for spiget and other tools and functions that need to be able to 
 * compare semantic versions.  This also addresses issues seen with incorrect
 * notifications within spiget.
